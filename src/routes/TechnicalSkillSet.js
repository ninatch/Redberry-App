    ...
    return checkFormValidation(user) ? (
        <div className="container">
            <div className="panel-left">
                <h1 className="title title-left">Tell us about your skills</h1>
                    <form className="skills-box" onSubmit={onSubmit}>
                        ...
                        <input type="submit" className="btn-main btn-small" value="Add Programming Language" />
                    </form>
                        {
